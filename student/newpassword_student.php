	...
	<section class="login" style="margin-top: 15rem;">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="login-form" style="background: #775FAD; padding:15px; border-radius: 15px;">
						...
						<form action="action.php" method="POST">
							...
							<div class="form-group mb-5">
								<input type="submit" class="btn btn-warning form-control" name="update_password_student" value="Update Password">
